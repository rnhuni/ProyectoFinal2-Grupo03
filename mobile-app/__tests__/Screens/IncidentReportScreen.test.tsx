...
describe('IncidentReportScreen', () => {
  let uploadFileMock: jest.Mock<any, any, any>, getUploadUrlMock: jest.Mock<any, any, any>, createIncidentMock: jest.Mock<any, any, any>;
  ...
  it('debería manejar el registro de un incidente con archivos adjuntos', async () => {
    ...
    fireEvent.changeText(getByTestId('description-input'), 'Incident description');
